        ...
        <section className="grid grid-cols-1 mt-3 px-4">
          <div className="flex w-full lg:w-2/4 mx-auto border border-slate-200 px-6 py-5 flex-col md:flex-row rounded-lg my-2 ">
            <img
              src={main}
              alt=""
              className="object-fit w-20 sm:w-48 mr-4 shadow-lg md:w-48  h-fit"
            />
            <div className="flex flex-col ">
              ...
              <p className="sm:text-sm text-xs text-slate-500">
                Let us take a look at how we can use React and Firebase to build
                a full stack application. The app includes authentication and
                more...
              </p>
              <div className="flex flex-cols gap-2 mt-1">
                <a
                  href="/"
                  className="flex items-center text-sm border  rounded-lg px-2 py-1 shadow-lg"
                >
                  <BsYoutube className="text-red-600 mr-1" /> Watch
                </a>
                <a
                  href="/"
                  className="flex items-center text-sm border  rounded-lg px-2 shadow-lg"
                >
          ...
          <div className="flex w-full lg:w-2/4 mx-auto border border-slate-200 px-6 py-5 flex-col md:flex-row rounded-lg my-2 ">
            ...
            <div className="flex flex-col mt-2">
              ...
              <div className="flex flex-cols gap-2 mt-1">
                <a
                  href="/"
                  className="flex items-center text-sm border  rounded-lg px-3 py-1 shadow-lg"
                >
                  <BsYoutube className="text-red-600 mr-1" /> Watch
                </a>
                <a
